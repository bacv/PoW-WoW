...
var commonCases = []testCase{
	{MsgRequest, "", Message{0x01}},
	{MsgChallenge, "test:2", Message{0x02, 0x74, 0x65, 0x73, 0x74, 0x3A, 0x32}},
	{MsgProof, "1::::::", Message{0x03, 0x31, 0x3a, 0x3A, 0x3A, 0x3A, 0x3A, 0x3A, }},
	{MsgWords, "of wisdom", Message{0x04, 0x6F, 0x66, 0x20, 0x77, 0x69, 0x73, 0x64, 0x6F, 0x6D }},
	{MsgError, "some error", Message{0x05, 0x73, 0x6F, 0x6D, 0x65, 0x20, 0x65, 0x72, 0x72, 0x6F, 0x72 }},
}
